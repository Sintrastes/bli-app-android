...
class config : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (id == R.id.about_action) startActivity(Intent(this@config, about::class.java))
        if (id == R.id.server_config_action) startActivity(Intent(this@config, config::class.java))
        if (id == R.id.settings_action) startActivity(Intent(this@config, settings::class.java))
